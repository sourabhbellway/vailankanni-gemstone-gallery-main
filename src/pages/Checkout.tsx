...
import { ArrowLeft, CreditCard, MapPin, Calendar, Gift, MessageSquare, Sparkles } from "lucide-react";
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 border ">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      <Label htmlFor="coupon_code" className="text-sm font-semibold text-gray-700">Coupon Code</Label>
